...
public:
  ...
  {}
  Init_RobotArmRequest_Request_action robot_id(::robocallee_fms::srv::RobotArmRequest_Request::_robot_id_type arg)
  {
...
{
  return robocallee_fms::srv::builder::Init_RobotArmRequest_Request_robot_id();
}
...
{
public:
  explicit Init_RobotArmRequest_Response_shelf_num(::robocallee_fms::srv::RobotArmRequest_Response & msg)
  : msg_(msg)
  {}
  Init_RobotArmRequest_Response_model shelf_num(::robocallee_fms::srv::RobotArmRequest_Response::_shelf_num_type arg)
  {
    msg_.shelf_num = std::move(arg);
...
public:
  ...
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_RobotArmRequest_Response_shelf_num action(::robocallee_fms::srv::RobotArmRequest_Response::_action_type arg)
  {
    msg_.action = std::move(arg);
...
{
  return robocallee_fms::srv::builder::Init_RobotArmRequest_Response_action();
}
